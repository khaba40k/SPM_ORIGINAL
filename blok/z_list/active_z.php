    ...
    foreach ($result as $row) {
        ...
        $div = new HTEL(
            ...
            [
                ...
                dateToNorm($row['date_out'], false, true),
                $_GET['type'],
                $variant,
                $ID,
                $style,
        ...
        if (!isset($_SESSION[$_SESSION['logged']]) || (!isset($_SESSION[$row['redaktor']]) && $_SESSION[$_SESSION['logged']] <= 1) || 
                    $_SESSION[$_SESSION['logged']] <= $_SESSION[$row['redaktor']]) {
